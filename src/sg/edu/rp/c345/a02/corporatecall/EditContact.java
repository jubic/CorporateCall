...
public class EditContact extends Activity {
	...
	private void setElements() {
		...
		addContactTV.setText(R.string.edit_contact);
		...
		funcET.setText(contactInfo.getFunction());
		compET.setText(contactInfo.getCompany());
		numbET.setText(contactInfo.getPhone());
	...
	private void insertContact() {
		...
		EditContactIntoXML(name, func, comp, numb);
	...
	private void EditContactIntoXML(String _name, String _func, String _comp,
			String _numb) {
		// Get the XML
		URL url;
